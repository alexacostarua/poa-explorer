defmodule Indexer.BlockFetcher.Realtime do
  ...
  def new(named_arguments) when is_list(named_arguments) do
    common_block_fetcher = Keyword.fetch!(named_arguments, :block_fetcher)
    block_fetcher = %BlockFetcher{common_block_fetcher | callback_module: __MODULE__, blocks_concurrency: 1}
